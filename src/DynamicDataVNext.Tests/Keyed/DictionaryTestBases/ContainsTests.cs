...
{
    public static readonly IReadOnlyList<TestCaseData> WhenItemIsInDictionary_TestCases
        = new[]
        {
    ...
    public static readonly IReadOnlyList<TestCaseData> WhenItemIsNotInDictionary_TestCases
        = new[]
        {
            new TestCaseData(new SingleItemOperationTestCase()
                {
