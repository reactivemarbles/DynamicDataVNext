...
{
    public static readonly IReadOnlyList<TestCaseData> WhenSetIsNotSubsetOfOther_TestCases
        = new[]
        {
    ...
    public static readonly IReadOnlyList<TestCaseData> WhenSetIsSubsetOfOther_TestCases
        = new[]
        {
            new TestCaseData(new SetOperationTestCase()
                {
            ...
            new TestCaseData(new SetOperationTestCase()
                {
                    Because = "the first set contains only items in the second set", 
                    Items   = new[] { 2, 3, 4 },
                    Other   = new[] { 1, 2, 3, 4, 5 }
                })
