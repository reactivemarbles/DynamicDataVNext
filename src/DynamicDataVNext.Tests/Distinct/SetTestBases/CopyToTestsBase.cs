    ...
    where TUut : ISet<int>
{
        ...
        int arrayIndex)
    {
        ...
        array[arrayIndex..(arrayIndex + items.Length)].Should().BeEquivalentTo(items, static options => options.WithStrictOrdering(), "all items in the set should have been copied to the array");
