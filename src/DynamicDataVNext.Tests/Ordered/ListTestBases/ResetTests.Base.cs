...
public static partial class ResetTests
{
            ...
            IRangeAwareList<string?>
    {
        ...
        public void WhenItemsAndListAreEmpty_DoesNothing()
        {
            ...
            fixture.Uut.Reset(Array.Empty<string?>());
        ...
        [TestCaseSource(typeof(ResetTests), nameof(WhenListIsNotEmpty_TestCases))]
        ...
        public void WhenItemsIsNull_DoesNothingAndThrowsException(IReadOnlyList<string?> initialItems)
        {
            ...
            fixture.Uut.Should().BeEquivalentTo(initialItems, static options => options.WithStrictOrdering(), "the list should not have been changed");
